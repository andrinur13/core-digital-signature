...
<div class="modal-body form-type-round">
   <div class="form-group row">
      <label class="col-4 col-lg-3 col-form-label">Nomor</label>
      <div class="col-8 col-lg-9">
         <p class="col-form-label font-weight-bold text-success">: <?php echo $data['srtNomorSurat']; ?></p>
      </div>
   </div>
   <div class="form-group row">
      <label class="col-4 col-lg-3 col-form-label">Jenis</label>
      <div class="col-8 col-lg-9">
   ...
   <div class="form-group row">
      <label class="col-4 col-lg-3 col-form-label">Klasifikasi</label>
      <div class="col-8 col-lg-9">
         <p class="col-form-label">: <?php echo $data['klasifikasi']; ?></p>
      </div>
   </div>
   <div class="form-group row">
      <label class="col-4 col-lg-3 col-form-label">Kategori</label>
      <div class="col-8 col-lg-9">
   ...
   ?>
         <div class="form-group row">
            <label class="col-4 col-lg-3 col-form-label"><?php echo $kolsurat['kolNama']; ?></label>
            <div class="col-8 col-lg-9">
   ...
   <div class="form-group row">
      <label class="col-4 col-lg-3 col-form-label">Status Konsep</label>
      <div class="col-8 col-lg-9">
   ...
   <?php } ?>
   <div class="form-group row">
      <label class="col-4 col-lg-3 col-form-label">File</label>
      <div class="col-8 col-lg-9">
         <div class="d-flex flex-row align-items-start">
   ...
   <?php if ($data['srtPejabatPtdNama'] != '') { ?>
      <div class="divider color-primary">Penandatangan</div>
      <div class="form-group row">
         <label class="col-4 col-lg-3 col-form-label">Nama Pejabat / NIPM</label>
         <div class="col-8 col-lg-9">
            <div class="d-flex flex-row align-items-start">
               <p class="col-form-label">: <?php echo $data['srtPejabatPtdNama'] . ' / ' . $data['srtPejabatPtdNipm']; ?></p>
            </div>
         </div>
      </div>
      <div class="form-group row">
         ...
         <div class="col-8 col-lg-9">
            <div class="d-flex flex-row align-items-start">
               <p class="col-form-label">: <?php echo $data['srtPejabatPtdJabatan']; ?></p>
            </div>
         </div>
      </div>
   <?php } ?>
