        ...
        <div class="row">
            ...
            <table class="table table-separated table-striped tab" id="datatables_ajax">
				...
				<tr role="row" class="heading">
					...
					<th width="2%">Jenis Klasifikasi Kode</th>
					<th width="5%">Nama Jenis Klasisifikasi</th>
					<th width="3%">Aksi</th>
				</tr>
				</thead>
			</table>
                ...
                <div class="card card-bordered card-body">
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input class="form-control" type="text" name="jnsklasKode">
                            <span class="invalid-feedback" id="error_jnsklasKode"></span>
                        </div>
                        <div class="form-group col-lg-6">
                            <label class="text-dark">Nama Jenis Klasisifikasi</label>
                            <input class="form-control" type="text" name="jnsklasNama">
                            <span class="invalid-feedback" id="error_jnsklasNama"></span>
                        </div>
