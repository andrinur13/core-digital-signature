        ...
        <div class="row">
            ...
            <table class="table table-separated table-striped tab" id="datatables_ajax">
				...
				<tr role="row" class="heading">
					...
					<th width="15%">Nama Kolom</th>
					<th width="5%">Nama Kolom</th>
					<th width="5%">Varaible Kolom</th>
					<th width="3%">Aksi</th>
				</tr>
				</thead>
			</table>
                ...
                <div class="card card-bordered card-body">
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input class="form-control" type="text" name="kolNama">
                            <span class="invalid-feedback" id="error_kolNama"></span>
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <option value="">-- Pilih Jenis Kolom --</option>
                                ...
                                foreach ($jenisKolom as $jenis) {
                                    echo "<option value='{$jenis}'>" . ucfirst($jenis) . "</option>";
                                }
                                ?>
                                
                            </select>
                            <span class="invalid-feedback" id="error_kolTipe"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12">
                            <label class="text-dark">Variable Kolom</label>
                            <input class="form-control" type="text" name="kolVariable" placeholder="Silahkan Gunakan %KOLOM_VARIABLE%">
