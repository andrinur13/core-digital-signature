...
class M_arsip_mandiri extends CI_Model
{
    function get_data( $object = array(), $limit = NULL, $offset = NULL, $order = array(), $status = NULL ){
		...
		$this->db->join('arsip','arsBerkasId=brksId AND arsTujuan is NOT NULL','LEFT');
    ...
    function get_data_arsip( $object = array(), $limit = NULL, $offset = NULL, $order = array(), $status = NULL ){
        ...
        $this->db->where('arsTujuan is NOT NULL', null, false);
    ...
    function get_list_arsip_internal(){
        ...
        $this->db->where('srtTujuanSurat is NOT NULL', null, false);
    ...
    function getDetailBerkas($brksId){
        ...
        $this->db->join('arsip','arsBerkasId=brksId AND arsTujuan IS NOT NULL');
        $this->db->join('surat','arsSuratId=srtId');
