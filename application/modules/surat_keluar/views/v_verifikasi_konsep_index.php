...
<script type="text/javascript">
   $(function() {
      ...
      var modalDetail = function(opt) {
         opt = opt || {};
         app.modaler({
            title: 'Detail Verifikasi Konsep Surat Keluar',
            url: opt.url,
            footerVisible: false,
            size: "lg",
      ...
      // ----------------- Verifikasi -----------------//
      var modalVerifikasi = function(opt) {
         opt = opt || {};
         app.modaler({
            title: 'Update Verifikasi Konsep Surat Keluar',
            url: opt.url,
            footerVisible: false,
            size: "lg",
            bodyExtraClass: "form-type-round",
      ...
      $('#datatables_ajax').on('click', '#verifikasi-btn', function(e) {
         // e.preventDefault();
         var id = $(this).attr('data-id'),
