		...
		<div class="card-body">
			...
			<table class="table table-separated table-striped" id="datatables_ajax" cellspacing="0" width="100%">
				<thead class="bg-color-primary1">
					<tr>
						<th class="font-weight-bold">Tanggal Surat</th>
						<th class="font-weight-bold">Asal</th>
						<th class="font-weight-bold">Nomor / Perihal Surat</th>
						<th class="font-weight-bold">Permohonan</th>
...
<script type="text/javascript">
	...
	function arahan(id) {
		module = "<?= site_url($module . '/datatables?tipe=detail_arahan&id=') ?>" + id;
		Modal({
			url: module,
			title: '<?= ($isPejabat == TRUE) ? 'Beri Arahan' : 'Ubah Arahan/Rapat' ?>',
			size: 'lg',
