        ...
        <input type="hidden" name="dokumen_id" value="<?= $dokumen_id ?>">
            <ul class="nav nav-process nav-process-circle">
                <li class="nav-item complete">
                    ...
                    <a class="nav-link" data-toggle="tab" href="<?= site_url($createStepZero) ?>"></a>
                </li>

                <li class="nav-item complete">
                    <span class="nav-title">Pemaraf</span>
                    <a class="nav-link " data-toggle="tab" href="<?= site_url($createStepTwo) ?>"></a>
                </li>

                <li class="nav-item processing">
                    <span class="nav-title">Penandatangan</span>
                    <a class="nav-link active" data-toggle="tab" href="#wizard-basic-3"></a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="pemaraf" data-provide="validation">
                    ...
                    <thead>
                        <tr>
                            <th  class="text-center">Kode Pejabat</th>
                            <th>Nama Pejabat</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr id="pejabat">
                                <td class="fw-400 kode_pejabat"><?= $row->pjbKode?></td>
                                <td class="fw-400 nama_pejabat"><?= $row->pjbNama?></td>
                                <td class="text-center jabatan_pejabat"><?= $row->pjbJabatan?></td>
                                <td class="text-center">
                                    <input type="hidden" id="id-pejabat" name="pejabat_id[]" value="<?= encode($row->pjbId);?>">                                    
                                    <a id="delPejabat" class="btn btn-square btn-danger text-white table-action"  data-provide="tooltip" title="Hapus Pejabat"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                        <?php
