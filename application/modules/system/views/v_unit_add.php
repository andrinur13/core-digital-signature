	...
	<div class="card-body">
		...
		<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control <?php echo (form_error('unitKode')) ? 'is-invalid' :''; ?>" id="unitKode" name="unitKode" value="<?php echo set_value('unitKode');?>">
					<?php echo form_error('unitKode'); ?>
				</div>
				<div class="form-group col-md-6">
					<label for="unitNama" class="col-form-label">Nama Unit</label>
					<input type="text" class="form-control <?php echo (form_error('unitNama')) ? 'is-invalid' :''; ?>" id="unitNama" name="unitNama" value="<?php echo set_value('unitNama');?>">
