		...
		<div class="card-body form-type-round">
            <div class="form-row">
				<div class="form-group col-md-12">
					...
					<input name="pjbNipm" id="form-field-1-1 inputWarning" required class="form-control <?php echo (form_error('pjbNipm')) ? 'is-invalid"' :''; ?>" type="text" value="<?php echo (isset($_POST['pjbNipm'])) ? set_value('pjbNipm') : $data->pjbNipm;?>" autocomplete="off">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input name="pjbtKode" id="form-field-1-1 inputWarning" class="form-control <?php echo (form_error('pjbtKode')) ? 'is-invalid"' :''; ?>" type="text" value="<?php echo (isset($_POST['pjbtKode'])) ? set_value('pjbtKode') : $data->pjbKode;?>" autocomplete="off" required>
				...
				<div class="form-group col-md-6">
					...
					<input name="pjbtNama" id="form-field-1-1 inputWarning" class="form-control <?php echo (form_error('pjbtNama')) ? 'is-invalid"' :''; ?>" type="text" value="<?php echo (isset($_POST['pjbtNama'])) ? set_value('pjbtNama') : $data->pjbNama;?>" autocomplete="off" required>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					...
					<input name="pjbtJabatan" id="form-field-1-1 inputWarning" class="form-control <?php echo (form_error('pjbtJabatan')) ? 'is-invalid"' :''; ?>" type="text" value="<?php echo (isset($_POST['pjbtJabatan'])) ? set_value('pjbtJabatan') : $data->pjbJabatan;?>" autocomplete="off">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url: '<?php echo site_url($module.'/ajax/load_view'); ?>',
                type: 'POST',
                data: { id: 'cari-form',user_id : '<?= encode($data->pjbUserId); ?>' },
                success: function(response){
                    $('#viewContainer').html(response);
                    $("#loadingIndicator").hide();
                },
