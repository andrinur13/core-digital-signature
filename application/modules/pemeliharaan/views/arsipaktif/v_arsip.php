...
<div class="card card-outline-primary">
    ...
    <div class="card-body" id="tbl-container">
        <div class="form-group row">
                <label class="col-4 col-lg-2 col-form-label" for="input-2">Klasifikasi</label>
                <div class="col-8 col-lg-10">
                    <p class="col-form-label">: <?= $detail_berkas['klasNama'] ?></p>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-4 col-lg-2 col-form-label" for="input-2">Nama Berkas</label>
                <div class="col-8 col-lg-10">
                    <p class="col-form-label">: <?= $detail_berkas['brksNama'] ?></p>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-4 col-lg-2 col-form-label" for="input-2">Jumlah</label>
                <div class="col-8 col-lg-10">
                    <p class="col-form-label">: <?= $detail_berkas['total_arsip'] ?></p>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-4 col-lg-2 col-form-label" for="input-2">Tanggal Arsip</label>
                <div class="col-8 col-lg-10">
                    <p class="col-form-label">: <?= IndonesianDate($detail_berkas['tanggal_minimal']) ?> - <?= IndonesianDate($detail_berkas['tanggal_maximal']) ?></p>
                    <div class="invalid-feedback"></div>
                </div>
            </div>

            <div class="divider color-primary">Daftar Arsip Surat</div>
...
var dt = $('#datatables_ajax').DataTable({
  ...
  "serverSide": true,
  "ajax" : {
     "url" : "<?php echo site_url( $module . '/ajax/datatables_arsip?arsip_id='.$ArsipId);?>",
     "type" : "POST",
     "data" : function(d) {
...
// });
    ...
    $('#add-btn').on('click', function() {
        var id = "<?= $ArsipId; ?>",
        module = "<?php echo site_url($module.'/add_arsip/') ?>" + id;
        modalAdd({
            url: module,
...
$('#form').on('submit', function(e) {
    ...
    $('#datatables_ajax').on('click', '#detail-btn', function() {
        ...
        module = "<?php echo site_url($module.'/arsip_detail/') ?>" + id;
        modalSetting({
            url: module,
            callback: function(modal) {
                $frm = modal.find('form');
