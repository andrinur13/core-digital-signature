        ...
        <input type="hidden" name="dokumen_id" value="<?= $dokumen_id ?>">
            <ul class="nav nav-process nav-process-circle">
                ...
                <li class="nav-item complete">
                    ...
                    <a class="nav-link " data-toggle="tab" href="#pemaraf"></a>
                </li>

                <li class="nav-item processing">
                    <span class="nav-title">Penandatangan</span>
                    <a class="nav-link active" data-toggle="tab" href="#penandatangan"></a>
                </li>
            </ul>


            <div class="tab-content">
                <div class="tab-pane fade active show" id="penandatangan" data-provide="validation">
                    <div class="form-row">
            ...
            <div class="flexbox">
                <a class="btn btn-secondary" href="<?php echo site_url($kembali); ?>">Kembali</a>
