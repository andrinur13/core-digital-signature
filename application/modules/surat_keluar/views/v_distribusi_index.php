...
<div class="card card-outline-primary">
   <div class="card-header">
      <h4 class="card-title"><strong>Data Distribusi Surat</strong></h4>
      ...
      <table class="table table-separated table-striped tab" cellspacing="0" id="datatables_ajax">
         <thead class="bg-color-primary1">
            <tr>
               ...
               <th class="font-weight-bold" width="12%">Tanggal</th>
               <th class="font-weight-bold" width="15%">No. Surat</th>
               <th class="font-weight-bold">Perihal</th>
               <th class="font-weight-bold" width="15%">Jenis</th>
               <th class="font-weight-bold" width="12%">Status Terakhir</th>
               <th class="font-weight-bold" width="12%">Status Distribusi</th>
...
<script type="text/javascript">
   $(function() {
      ...
      var modalDetail = function(opt) {
         opt = opt || {};
         app.modaler({
            title: 'Detail Distribusi Surat Keluar',
            url: opt.url,
            footerVisible: false,
            size: "lg",
      ...
      // ----------------- Distribusi -----------------//
      var modalDistribusi = function(opt) {
         opt = opt || {};
         app.modaler({
            title: 'Distribusi Surat Keluar',
            url: opt.url,
            footerVisible: false,
            size: "lg",
            bodyExtraClass: "form-type-round",
      ...
      $('#datatables_ajax').on('click', '#distribusi-btn', function() {
         var id = $(this).attr('data-id'),
            module = "<?php echo site_url($module . '/distribusi/') ?>" + id;
         modalDistribusi({
            url: module,
         });
      });
